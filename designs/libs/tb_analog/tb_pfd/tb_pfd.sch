...
N 410 -130 410 -110 {lab=GND}
N 540 -150 540 -130 {lab=GND}
N 360 -210 410 -210 {lab=DOWN}
N 410 -210 410 -190 {lab=DOWN}
N 360 -250 490 -250 {lab=UP_B}
N 540 -250 540 -210 {lab=UP_B}
N 540 -250 560 -250 {lab=UP_B}
N 410 -210 430 -210 {lab=DOWN}
N 490 -250 540 -250 {lab=UP_B}
N 400 -380 400 -360 {lab=GND}
N 400 -460 400 -440 {lab=CLK_FB}
N 120 -250 160 -250 {lab=CLK_IN}
N 120 -210 160 -210 {lab=CLK_FB}
...
C {gnd.sym} 410 -110 0 0 {name=l26 lab=GND}
C {res.sym} 410 -160 0 0 {name=R1
value=100k
footprint=1206
device=resistor
m=1}
...
C {gnd.sym} 540 -130 0 0 {name=l1 lab=GND}
C {res.sym} 540 -180 0 0 {name=R2
value=100k
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 560 -250 0 1 {name=p8 sig_type=std_logic lab=UP_B}
C {lab_pin.sym} 430 -210 0 1 {name=p9 sig_type=std_logic lab=DOWN}
...
C {lab_pin.sym} 120 -250 0 0 {name=p3 sig_type=std_logic lab=CLK_IN}
C {lab_pin.sym} 120 -210 0 0 {name=p10 sig_type=std_logic lab=CLK_FB}
