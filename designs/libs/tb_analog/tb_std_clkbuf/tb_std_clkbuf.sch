...
autoload=1
rainbow=1
rawfile=$netlist_dir/tb_std_clkbuf_dc.raw}
...
autoload=1
rainbow=1
rawfile=$netlist_dir/tb_std_clkbuf_tran.raw
y2=3.3
color=4
node=outy1}
...
color=4
node=vina}
T {Standard cell clkbuf 16} 0 -1170 0 0 1 1 {}
...
* DC analysis
dc v1 0 3.3 0.1
write tb_std_clkbuf_dc.raw

* TRANS analysis
tran 1u 2m
write tb_std_clkbuf_tran.raw
.endc
"}
...
tclcommand="
xschem raw_read $netlist_dir/tb_std_clkbuf_dc.raw
xschem raw_read $netlist_dir/tb_std_clkbuf_tran.raw
...
device=resistor
m=1}
C {designs/libs/gf180mcu_stdcells/clkbuf_16.sym} 240 -730 0 0 {name=x1 VGND=GND VNB=VDD VPB=GND VPWR=VDD prefix=gf180mcu_fd_sc_mcu7t5v0__ }
