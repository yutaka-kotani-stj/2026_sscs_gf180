...
N 140 -360 200 -360 {lab=VNW}
N 140 -320 200 -320 {lab=VPW}
...
N 650 -360 650 -340 {lab=VNW}
N 650 -340 680 -340 {lab=VNW}
...
C {devices/lab_pin.sym} 140 -360 0 0 {name=l28 sig_type=std_logic lab=VNW}
C {devices/lab_pin.sym} 140 -320 0 0 {name=l29 sig_type=std_logic lab=VPW}
...
C {devices/lab_pin.sym} 680 -340 0 1 {name=l12 lab=VNW}
C {devices/lab_pin.sym} 680 -200 0 1 {name=l13 lab=VPW}
...
C {iopin.sym} 200 -360 0 0 {name=p3 lab=VNW}
