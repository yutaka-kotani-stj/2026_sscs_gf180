...
N 720 -360 740 -360 {lab=VOUT}
N 740 -360 740 -180 {lab=VOUT}
N 720 -180 740 -180 {lab=VOUT}
N 650 -190 650 -180 {lab=GND}
N 650 -360 650 -340 {lab=VDD}
N 650 -340 680 -340 {lab=VDD}
N 680 -360 720 -360 {lab=VOUT}
N 680 -180 720 -180 {lab=VOUT}
N 650 -200 650 -190 {lab=GND}
N 650 -200 680 -200 {lab=GND}
N 580 -280 600 -280 {lab=A}
N 740 -280 760 -280 {lab=VOUT}
...
C {devices/lab_pin.sym} 140 -320 0 0 {name=l29 sig_type=std_logic lab=GND}
C {ipin.sym} 200 -360 0 1 {name=p1 lab=VDD}
C {ipin.sym} 200 -320 0 1 {name=p2 lab=GND}
...
C {devices/lab_pin.sym} 680 -200 0 1 {name=l13 sig_type=std_logic lab=GND}
