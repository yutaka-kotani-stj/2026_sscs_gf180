...
C {devices/lab_pin.sym} 680 -340 0 1 {name=l12 lab=VDD}
C {devices/lab_pin.sym} 680 -200 0 1 {name=l13 lab=GND}
...
C {iopin.sym} 200 -360 0 0 {name=p3 lab=VDD}
C {iopin.sym} 200 -320 0 0 {name=p1 lab=GND}
